...
export const PRODUCTS = {
  SUPREME: { name: "SUPREME", amount: 1250, description: "RANK SUPREME" },
  LEGEND: { name: "LEGEND", amount: 820, description: "RANK LEGEND" },
  "TITAN+": { name: "TITAN+", amount: 690, description: "RANK TITAN+" },
  TITAN: { name: "TITAN", amount: 400, description: "RANK TITAN" },
  "MVP+": { name: "MVP+", amount: 339, description: "RANK MVP+" },
  MVP: { name: "MVP", amount: 299, description: "RANK MVP" },
  VIP: { name: "VIP", amount: 199, description: "RANK VIP" }
};
...
export function normalizeBaseUrl(value) {
  ...
  try {
    ...
    throw new Error("SITE_URL указан неверно. Используй полный HTTPS-адрес, например https://sandwi4-smp.vercel.app");
  }
}
